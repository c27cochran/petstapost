        ...
        <div id="custom-content-<?php echo $item_id;?>" class="white-popup-block" style="max-width:520px; padding: 40px 20px 0 20px;">
            <?php
                if (!empty($caption)) {
                    if ($verified == '1') {
            ?>
                          <h2 class="popup-caption my-caption" style="margin: 0 0 10px;"><?php echo convertLinks($caption); ?>
                            <a href="javascript:void(0);" class="edit-caption-pencil comment-link">
                                <i class="fa fa-pencil"></i>
                            </a>
                          </h2>
                          <textarea maxlength="160" id="edit-caption-<?php echo $item_data["item_id"];?>" autofocus class="form-control edit-caption-textarea hidden"><?php echo $caption;?></textarea>
            ...
            <?php
                    ...
                    if ($verified == '1') { ?>
                          <h2 class="popup-caption my-caption" style="margin: 0 0 10px;">
                            <a href="javascript:void(0);" class="edit-caption-pencil comment-link">
                                <i class="fa fa-pencil"></i>
                            </a>
                          </h2>
        ...
        <div id="custom-content-<?php echo $item_id;?>" class="white-popup-block" style="max-width:600px;">
            <?php
                if (!empty($caption)) {
                    if ($verified == '1') {
            ?>
                        <h2 class="popup-caption my-caption" style="margin: 7px 20px 20px;"><?php echo convertLinks($caption); ?>
                            <a href="javascript:void(0);" class="edit-caption-pencil comment-link">
                                <i class="fa fa-pencil"></i>
                            </a>
                        </h2>
                        <textarea maxlength="160" autofocus id="edit-caption-<?php echo $item_data["item_id"];?>" class="form-control edit-caption-textarea hidden"><?php echo $caption;?></textarea>
                        <button type="submit" class="btn btn-primary btn-edit-caption btn-block hidden">
                            Change Caption
                        </button>
            <?php
            ...
            <?php   }
                    ...
                    if ($verified == '1') { ?>
                          <h2 class="popup-caption my-caption" style="margin: 7px 20px 20px;">
                            <a href="javascript:void(0);" class="edit-caption-pencil comment-link">
                                <i class="fa fa-pencil"></i>
                            </a>
                          </h2>
