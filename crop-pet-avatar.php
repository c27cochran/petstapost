<?php
  ...
  class CropPetAvatar {
    ...
    private function setFile($file) {
      ...
      if ($errorCode === UPLOAD_ERR_OK) {
        ...
        if ($type) {
          ...
          $src = $dir . '/' . $_POST['username'] . '-pet-avatar' . $extension;
    ...
    private function setDst() {
      ...
      if (file_exists($dir . '/' . $_POST['username'] . '-pet-avatar' . '.png')) {
        unlink($dir . '/' . $_POST['username'] . '-pet-avatar' . '.png');
      }
      ...
      $this -> dst = $dir . '/' . $_POST['username'] . '-pet-avatar' . '.png';
    }
  ...
  $crop = new CropPetAvatar($_POST['pet_avatar_src'], $_POST['pet_avatar_data'], $_FILES['pet_avatar_file']);

  $_SESSION['pet_img_url'] = $crop -> getResult();

  $response = array(
    'state'  => 200,
    'message' => $crop -> getMsg(),
    'result' => $_SESSION['pet_img_url']
  );
