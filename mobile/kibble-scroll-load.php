<?php
    ...
    $kibble_data = $items->get_kibble($user_id, $position, $items_per_group);
    $kibble_count = count($kibble_data);
    $total_count = $items->get_kibble_group_count($user_id);
    ...
    ?>
                ...
                <div id="kibble_item_<?php echo $result['item_id'];?>" class="col-md-6 profile-item">
                    ...
                    <a href="yappy.html?user=<?php echo $result['username'];?>">
                    ...
                    <?php 
                        if ($result['filter'] == 'video') { ?>
                            <div class="img-responsive" style="background:url(<?php echo $result['url'];?>) no-repeat; background-size: 100%; margin-top: 22px;">
                                <a class="simple-ajax-popup-align-top" href="http://petstapost.com/mobile/get-item.php?item=<?php echo $result['item_id'];?>&user=<?php echo $user_id;?>">
                                    <img class="img-responsive" src="http://petstapost.com/img/video-overlay.png">
                                </a>
                            </div>
                    <?php
                        } else {
                    ...
                    ?>
                        ...
                        <a id="item_<?php echo $result['item_id'];?>" href="javascript:void(0);" class="favorite left">
                            <?php
                                if ($favorites->already_favorited($result['item_id'], $user_id) === true) {
                ...
                $(document).ready(function() {
                    ...
                    $.ajax({
                            type: "GET",
                            url: "http://petstapost.com/util/show-limited-comments-feed",
