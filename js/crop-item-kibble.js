(function (factory) {
  ...
  ItemCover.prototype = {
    ...
    cropDone: function () {
      ...
      // var filter = $("#item-filter").text();
      $('#script-container').html("<script>$('.item-pic-upload').transloadit({wait: true, params: {auth: { key: 'confidential' }, template_id: '9b2c9990db9c11e49386c106d2f35d88', redirect_url: 'http://petstapost.com/yappy.php?user="+username+"',steps: {store: {path: '"+username+"/"+filename+"'}, import: {robot: '/http/import',url: '"+img_url+"'}}}});</script>");
    },
